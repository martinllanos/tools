...
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/account-consolidation.git OCA-account-consolidation
...
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/apps-store.git OCA-apps-store
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/bank-payment.git OCA-bank-payment
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/calendar.git OCA-calendar
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/commission.git OCA-commission
...
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/delivery-carrier.git OCA-delivery-carrier
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/e-commerce.git OCA-e-commerce
...
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/management-system.git OCA-management-system
...
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/margin-analysis.git OCA-margin-analysis
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/multi-company.git OCA-multi-company
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/oca-custom.git OCA-oca-custom
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/OpenUpgrade.git OCA-OpenUpgrade
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/operating-unit.git OCA-operating-unit
...
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/stock-logistics-transport.git OCA-stock-logistics-transport
...
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/website-themes.git OCA-website-themes
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/website.git OCA-website
git clone --depth 1 --branch 11.0 --single-branch https://github.com/OCA/contract.git OCA-contract
cd ~/server/11/sources
